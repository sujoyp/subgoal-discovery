...
parser.add_argument('--model-name', default='weakloc_newtraj', help='name to save model')
...
parser.add_argument('--num-subgoals', type=int, default=4, help='number of subgoals (default: 4)')
